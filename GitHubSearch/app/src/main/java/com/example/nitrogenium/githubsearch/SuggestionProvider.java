...
public class SuggestionProvider extends ContentProvider {
    ...
    /**
     * It handles requests from the Search Manager'a.
     * When a particular item is requested, it is only required URI.
     * When prompted to search the entire table, the first element of the parameter selectionArgs contains the query string.
     * The rest of the parameters are not needed.
     */
    @Override
     ...
     * Need to compare different URI specific values
     */
